<template>
	<div class="ui-card" >
		<div class="ui-card-header">
			<div class="ui-card-title">Liste d'Auteurs</div>
		</div>
			...
			<div class="ui-table" >
			    <div class="ui-table-header">
			        <div class="ui-table-row">
			            ...
			            <div class="ui-table-cell">Nom Complet</div>
			    ...
			    <div class="ui-table-body" >
			        <div class="ui-table-row " v-for="T in TT">
			            ...
			            <div class="ui-table-cell">{{T.nomComplet}}</div>
...
<script>
	...
	export default {
	    ...
	    methods: {
			async supprimer(T){
	      		const [ok,message] = await api_fetch(this,'delete',config.URL_AUTEUR+'/'+T.id,null,'ok');
	      		if (ok)
	      			setTimeout(()=>{this.$router.go(this.$router.currentRoute);},1000);
			},
	    },
	    async mounted() {
	    	const [ok,message] = await api_fetch(this,'get',config.URL_AUTEUR);
	      	if (ok)
	      		this.TT=message;
	    },
